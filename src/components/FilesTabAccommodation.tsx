...
const FilesTabAccommodation = ({ accommodation, files, setFiles }) => {
    ...
    const fetchFiles = async () => {
        try {
            ...
            if (response.ok) {
                const documentsAccommodation = await response.json();
                console.log('Fichiers récupérés:', documentsAccommodation);
                setFiles(documentsAccommodation);
            } else {
...
export default FilesTabAccommodation;